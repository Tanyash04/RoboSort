...
def setup_environment():
    ...
    lid_visual = p.createVisualShape(
        shapeType=p.GEOM_MESH,
        fileName=r"./3dmodels/Lid_square_90.obj",
        meshScale=[1.5, 1.5, 1.5],
    ...
    p.changeDynamics(lid, -1, lateralFriction=3000, spinningFriction=1500, rollingFriction=1500)
...
def close_gripper(robot, left_finger, right_finger, steps=150, force=7000):
...
def run_simulation(env):
    ...
    grasp_x, grasp_y, grasp_z = 0.316,	0.158,	0.34
    ...
    move_to_target(robot, [grasp_x, grasp_y, grasp_z+0.02   ], ee_index)  
    #open_gripper(robot, left_finger, right_finger)
    ...
    if verify_grasp(robot, lid):
        ...
        drop_x, drop_y, drop_z = 0.3, -0.3, 0.25  
